<?php
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $sWhere = "";
		 $sWhere.=" WHERE pedido.id_cliente=clientes.id_cliente";
		if ( $_GET['q'] != "" )
		{
			...
			<div class="table-responsive">
			  <table class="table">
				<tr  class="info">
					...
					<th>Cliente</th>
					<th>Estado</th>
					<th class='text-right'>Total Area</th>
				...
				while ($row=mysqli_fetch_array($query)){
						...
						if ($estado_pedido=='Enviado'){$text_estado="Pediente";$label_class='label-warning';}
					...
					<tr>
						...
						<td class='text-right'><?php echo number_format ($AreaTotal,2); ?> m<SUP>2</SUP> </td>					
					<td class="text-right" >
						<a href="cotizacion.php?idpedido=<?php echo $idpedido;?>" class='btn btn-default' title='Registrar Cotizacion'><i class="glyphicon glyphicon-file"  ></i></a> <!--
