<?php
	...
	$sql=mysqli_query($con,"select DISTINCT idpersonal  from cotizacion inner join cotizacion_personal on cotizacion_personal.idcotizacion = cotizacion.idcotizacion 
        ...
        OR FechaTermino BETWEEN '".$fechaInicio."' AND '".$fechaTermino."') and not cotizacion.idcotizacion = '".$idcotizacion."'");
	...
	else
	{
        ...
        OR FechaFinal_tmp BETWEEN '".$fechaInicio."' AND '".$fechaTermino."') and id_cotizacion = '".$idcotizacion."' and session_id='".$session_id."'");
		...
		<?php
			...
			while ($row1=mysqli_fetch_array($sql1))
			{
				...
				if($bool==0)
				{
					...
					if($count2>0)
					{
						$sql2=mysqli_query($con,"select id_Personal from tmp_personal where id_cotizacion = ".$idcotizacion." and session_id='".$session_id."' and id_Personal='".$idpersonal_1."'");
