...
function agregar_materiales(id)
		{
			...
			//alert(id);
			var idmaterial = id;
			var idcotizacion = $("#idcotizacion_1").val();			
			...
			//Fin validacion
				...
				$.ajax({
	        		type: "POST",
	        		url: "./ajax/actualizar_producto_cotizacion.php",
	        		data: "idmaterial="+id+"&idcotizacion="+idcotizacion+"&precio_venta="+precio_venta+"&cantidad="+cantidad+"&depreciacion="+depreciacion,
			...
			else
			{
				...
				data: "idmaterial="+id+"&idcotizacion="+idcotizacion,
				beforeSend: function(objeto){
						$("#resultados").html('<img src="./img/ajax-loader.gif"> Cargando...');
		  		 },
        		success: function(datos){
		...
		function eliminar (id)
		{
        	...
        	function(){
				...
				$.ajax({
	        		type: "GET",
	        		url: "./ajax/actualizar_producto_cotizacion.php",
	        		data: "idmaterial="+id+"&idcotizacion="+idcotizacion+"&action="+1,
			 		beforeSend: function(objeto){
						$("#resultados").html('<img src="./img/ajax-loader.gif"> Cargando...');
			  		},
	        		success: function(datos){
		...
		function editar()
		{
			...
			$.ajax({
        		type: "GET",
        		url: "./ajax/actualizar_producto_cotizacion.php",
        		data: "idmaterial="+id+"&idcotizacion="+idcotizacion+"&cantidad="+cantidad+"&action="+2,
		 		beforeSend: function(objeto){
					$("#resultados").html('<img src="./img/ajax-loader.gif"> Cargando...');
		  		},
        		success: function(datos){
		...
		function agregar_personal(fechaEsperada)
		{
			...
			$.ajax({
	        		type: "POST",
	        		url: "./ajax/actualizar_personal_cotizacion.php",
	        		data: "idcotizacion="+idcotizacion+"&fechaInicio="+fechaI+"&fechaTermino="+fechaF,
					//data: "idmaterial="+id+"&idpedido="+idpedido,
					beforeSend: function(objeto){
		...
		function RegistrarPersonal()
		{
			...
			$.ajax({
	        		type: "POST",
	        		url: "./ajax/actualizar_personal.php",
	        		data: "idcotizacion="+idcotizacion+"&action="+action
					});
			action = 'grabar';
			for(x=0; x<cont.length; x++)
			{
				if(cont[x].checked)
				{
				   ...
				   $.ajax({
	        		type: "POST",
	        		url: "./ajax/actualizar_personal.php",
	        		data: "idpersonal="+idpersonal+"&idcotizacion="+idcotizacion+"&action="+action+"&fechaInicio="+fechaI+"&fechaTermino="+fechaF,
					//data: "idmaterial="+id+"&idpedido="+idpedido,
					beforeSend: function(objeto){
		...
		function guardarCotizacion()
		{
			...
			swal({
  		  	title:"¿Está seguro?",
  		  	text: "La cotización cambiará de estado a 'Pendiente'!.",
  		  	type: "warning",
  		  	showCancelButton: true,
  		  	cancelButtonText: "Cancelar",
          	confirmButtonColor: "#DD6B55",
        	...
        	function(){
				...
				$.ajax({
		        		type: "POST",
		        		url: "./ajax/actualizar_personal.php",
		        		data: "idcotizacion="+idcotizacion+"&action="+action+"&fechaInicio="+fechaI+"&fechaTermino="+fechaF,
